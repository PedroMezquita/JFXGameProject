...
public class Niveau1 extends Niveau{
    ...
    public Map load() {
        ...
        AttackPattern atqJoueur = new AttackPattern(25, 3, 5, 20, "fleche", 50);
        joueur.setAttaque(atqJoueur);
        map.addEntity(joueur);
        Ennemi ennemi = new Ennemi(1,1,10,10,10,10,5, 15, 15, 250, 400, "ennemi1", 1,1,0);
