...
public class Niveau5 extends Niveau{
    ...
    public Map load() {
        ...
        Personnage joueur = new Joueur(100,1,1,10,1,10,5,"mec", /* 21*/ 41, /* 21*/41,20,20,"joueur", 1,0,0); //Le joueur charge avant les props
        ...
        Ennemi ennemi = new Ennemi(10,1,100,10,100,10,3, 100, 100, 200, 350, "ennemi1", 1,1,0);
