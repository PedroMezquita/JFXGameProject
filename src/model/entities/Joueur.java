...
public abstract class Joueur extends Personnage { //point d'extensibilité
    ...
    public Joueur(int atkPnt, int magPnt, int maxHP, int maxMana, int currentHP, int currentMana, int speed, String name, int xsize, int ysize, int xpos, int ypos, int id) {
